...
delivery. We suspect a secret agent from Amazon placed an order and stole one of our patented drones. To track them down
...
print(find_unique_delivery_id([1, 1, 2, 1, 3, 2, 1]))